...
class _RetrofitClient implements RetrofitClient {
  _RetrofitClient(
    ...
    baseUrl ??= 'https://api.binahayatkala.com/api/v1/';
  }
  ...
  @override
  Future<SendCodeResponse?> loginSendCode(Map<String, dynamic> data) async {
  ...
  @override
  Future<TokenResponse?> loginValidateCode(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<WeatherResponse?> getWeatherByLatLng(
    ...
    final value =
        _result.data == null ? null : WeatherResponse.fromJson(_result.data!);
    return value;
  }
